        ...
        <div className="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
          <ul className="navbar-nav">
            <li className="nav-item ">
              ...
              <Link className="nav-link active " aria-current="page" to="/">Home <FontAwesomeIcon icon={faHome} /></Link>
            </li>
            {isLoggedIn() ? null : <>  <li className="nav-item ">
              <Link className="nav-link active " aria-current="page" to="/login">Login  <FontAwesomeIcon icon={ faSignInAlt} /></Link>
            </li>
            <li className="nav-item 1">
              <Link className="nav-link active " aria-current="page" to="/register">Register  <FontAwesomeIcon icon={ faUserPlus } /></Link>
            </li>  </>}
